...
class ApiClient {
  ApiClient({this.basePath = 'https://stage.postoplan.app/oapi/v1'}) {
    // Setup authentications (key: authentication name, value: authentication).
    _authentications[r'api-key'] = ApiKeyAuth('header', 'api-key');
    _authentications[r'api-token'] = ApiKeyAuth('header', 'api-token');
  }
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'AuthRequest':
          return AuthRequest.fromJson(value);
        case 'AuthResponse':
          return AuthResponse.fromJson(value);
        case 'AuthResponseAllOf':
          return AuthResponseAllOf.fromJson(value);
        case 'Language':
